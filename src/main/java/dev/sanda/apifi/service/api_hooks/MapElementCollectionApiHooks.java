...
public interface MapElementCollectionApiHooks<TMapKey, TMapValue, T> {
  default void prePut(
    Map<TMapKey, TMapValue> inputToPut,
    String fieldName,
    T ownerInstance,
    DataManager<T> ownerDataManager
  ) {}

  default void postPut(
    Map<TMapKey, TMapValue> inputToPut,
    String fieldName,
    T ownerInstance,
    DataManager<T> ownerDataManager
  ...
  default void postFreeTextSearch(
    Page<Map.Entry<TMapKey, TMapValue>> returnPage,
    FreeTextSearchPageRequest request,
    T ownerInstance,
    DataManager<T> ownerDataManager
  ) {}

  default Page<Map.Entry<TMapKey, TMapValue>> executeCustomFreeTextSearch(
