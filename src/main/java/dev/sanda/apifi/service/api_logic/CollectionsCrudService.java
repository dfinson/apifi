...
public class CollectionsCrudService<T> extends BaseCrudService<T> {
    ...
    getEntityCollectionImpl(List<T> input, String collectionFieldName, E collectionApiHooks, DataManager<TCollection> collectionDataManager) {
    ...
    List<TCollection> updateEntityCollectionImpl(
            T owner,
            DataManager<TCollection> collectionDataManager,
    ...
    public  <TCollection, E extends ElementCollectionApiHooks<TCollection, T>> List<TCollection>
    removeFromElementCollectionImpl(T input, String fieldName, List<TCollection> toRemove, E elementCollectionApiHooks){
    ...
    addToMapElementCollectionImpl(T input, String fieldName, Map<TMapKey, TMapValue> toPut, E apiHooks){
        var temp = dataManager.findById(getId(input, reflectionCache)).orElse(null);
        if (temp == null) throw_entityNotFound(input, reflectionCache);
        input = temp;
        if(apiHooks != null)
    ...
    public  <TMapKey, TMapValue, E extends MapElementCollectionApiHooks<TMapKey, TMapValue, T>>
    Map<TMapKey, TMapValue>
    removeFromMapElementCollectionImpl(T input, String fieldName, List<TMapKey> toRemove, E elementCollectionApiHooks){
        var temp = dataManager.findById(getId(input, reflectionCache)).orElse(null);
        if (temp == null) throw_entityNotFound(input, reflectionCache);
        input = temp;
        if(elementCollectionApiHooks != null)
    ...
    public  <TMapKey, TMapValue, E extends MapElementCollectionApiHooks<TMapKey, TMapValue, T>>
    Page<Map.Entry<TMapKey, TMapValue>> getFreeTextSearchPaginatedBatchInMapElementCollectionImpl(
            T owner,
            dev.sanda.datafi.dto.FreeTextSearchPageRequest input,
            String fieldName,
            E apiHooks) {
    ...
    private <TCollection> Collection<TCollection> initCollection(String fieldName){
